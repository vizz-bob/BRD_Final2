...
const TAX_OPTIONS = [
  ...
  { label: "Surcharge (2%)", value: "SURCHARGE_2" },
  { label: "Surcharge (5%)", value: "SURCHARGE_5" },
];

const SEQUENCE_OPTIONS = [
  { label: "Penalty First", value: "PENALTY_FIRST" },
  { label: "Charges First", value: "CHARGES_FIRST" },
...
const AddPenalty = ({ onClose, onSuccess }) => {
  const [form, setForm] = useState({
    ...
    rate_of_penalty: "",
    tax_mapping: "NONE",
    sequence_of_adjustment: "PENALTY_FIRST",
    status: "ACTIVE",
  });
  ...
  const validate = (v) => {
    ...
    else if (Number(v.rate_of_penalty) < 0) e.rate_of_penalty = "Rate cannot be negative";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-8 py-5 border-b border-gray-100">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Add Penalty</h2>
            <p className="text-sm text-gray-500 mt-0.5">Define penalties for non-compliance or delays</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto flex-1 px-8 py-6 space-y-8">
          ...
          <Section title="Penalty Details">
            <StyledInput
              ...
              onChange={(e) => handleChange("penalty_name", e.target.value)}
              onBlur={() => handleBlur("penalty_name")}
              error={fieldErrors.penalty_name}
            />
            ...
            <StyledInput
              ...
              placeholder="e.g. 2.5"
              onChange={(e) => handleChange("rate_of_penalty", e.target.value)}
              onBlur={() => handleBlur("rate_of_penalty")}
              error={fieldErrors.rate_of_penalty}
            />
          </Section>
