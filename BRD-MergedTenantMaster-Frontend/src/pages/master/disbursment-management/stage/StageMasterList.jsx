...
export default function StageMasterList() {
  ...
  useEffect(() => {
    setData([
      { id: 1, stage_name: "Pre-Approval", description: "Before loan approval", status:"Active" },
      { id: 2, stage_name: "Disbursement", description: "At time of fund release", status:"Inactive" }
    ]);
  }, []);
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-xl font-semibold">Stage of Down Payment</h1>
          <p className="text-sm text-gray-500">
            Define disbursement stages for down payment
          </p>
        </div>
        ...
        {filtered.map((row) => (
          ...
          >
            ...
            <div className="flex justify-end gap-2 col-span-2 md:col-span-1">
              ...
              <button
                onClick={() => { setDeleteId(row.id); setShowDelete(true); }}
