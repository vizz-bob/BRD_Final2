...
export default function AgencyList() {
  ...
  useEffect(() => {
    // TEMP MOCK DATA
    setData([
      { id: 1, name: "State Bank", type: "Govt", contact: "sb@bank.com", status: "Active" },
      { id: 2, name: "ABC Finance", type: "Private", contact: "abc@finance.com", status: "Inactive" }
    ]);
  }, []);
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-xl font-semibold">Agency Master</h1>
          <p className="text-sm text-gray-500">
            Define agencies involved in disbursement process
          </p>
        </div>
      ...
      <div className="space-y-3">
        ...
        {filtered.map((row) => (
          ...
          >
            ...
            {/* Type */}
            <div className="text-gray-600 hidden md:block">{row.type}</div>

            {/* Contact */}
            <div className="text-gray-600">{row.contact}</div>
