...
export default function VendorAdd() {
  ...
  return (
    <>
      <h1 className="text-xl font-semibold mb-1">Add Vendor</h1>
      <p className="text-sm text-gray-500 mb-6">
        Onboard a new external partner to the loan lifecycle workflow
      </p>
...
const base = (err) =>
  `w-full mt-0 p-2 border rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-300 transition-all ${
    err ? "border-red-400 bg-red-50" : "border-gray-300"
  }`;
const input = (err) => base(err);
