...
import LoanUnderwritingConsole from "../../components/tenant/LoanUnderwritingConsole";
import ProductSelectionModal from "../../components/tenant/ProductSelectionModal";
...
export default function LoanApplications() {
  ...
  const fetchApplications = useCallback(async () => {
    ...
    try {
      ...
      const normalized = dataArray.map((app) => ({
