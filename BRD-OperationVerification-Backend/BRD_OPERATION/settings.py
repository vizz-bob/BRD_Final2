...
SECRET_KEY = 'django-insecure-p@wn&blx^!^dmu+g8qru$rrlhtigj0wq2#u08yq*b5yh(b9&b3'
...
ROOT_URLCONF = 'BRD_OPERATION.urls'
MEDIA_URL = '/media/'
...
WSGI_APPLICATION = 'BRD_OPERATION.wsgi.application'
