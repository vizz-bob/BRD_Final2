...
export default function WriteoffRuleForm() {
  const { id } = useParams();
  ...
  const submit = (e) => {
    e.preventDefault();
    console.log("WRITE-OFF RULE:", form);
    navigate(-1);
  };
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-semibold">
            {isEdit ? "Edit Write-off Rule" : "Add Write-off Rule"}
          </h1>
          <p className="text-sm text-gray-500">
            Manage write-off eligibility configuration
          </p>
        </div>
      </div>
