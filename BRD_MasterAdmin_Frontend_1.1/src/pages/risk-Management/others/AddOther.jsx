...
export default function AddOther() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Add Other Parameter:", formData);

    // Later → API
    // await otherService.create(formData);
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-semibold">
            Add Custom Risk Parameter
          </h1>
          <p className="text-sm text-gray-500">
            Create temporary or conditional risk rules
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              required
              placeholder="e.g. Temporary High Risk PIN"
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              required
              placeholder="e.g. 302019 / Limit +10%"
              className="mt-1 w-full rounded-xl border border-gray-300 px-3 py-2 text-sm"
            />
          </div>
