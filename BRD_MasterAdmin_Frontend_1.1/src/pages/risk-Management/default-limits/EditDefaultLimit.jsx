...
export default function EditDefaultLimit() {
  ...
  useEffect(() => {
    ...
    setFormData({
      acceptable_npa: mockLimit.acceptable_npa,
      default_threshold_days:
        mockLimit.default_threshold_days,
      default_trigger: mockLimit.default_trigger,
      default_impact_score: mockLimit.default_impact_score,
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Update Default Limit:", {
      id,
      ...formData,
    });

    // Later → API
    // await defaultLimitService.update(id, formData);
    ...
    <MainLayout>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            Update NPA limits, default thresholds, and impact
            score
          </p>
        </div>
      </div>
