...
export default function AddRCU() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("RCU Data:", formData);

    // Later → API
    // await rcuService.create(formData);
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            Log early warning signals and RCU actions
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              rows={4}
              required
              placeholder="Describe actions taken by RCU team"
