...
const ChangeLoanProduct = () => {
  ...
  const validate = (v) => {
    ...
    if (!v.new_product) {
      e.new_product = "Please select a new loan product";
    }
  ...
  return (
    <MainLayout>
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-semibold">Change Loan Product</h1>
          <p className="text-sm text-gray-500">
            Switch the loan to a different product
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm mb-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
        ...
        <Info label="Current Product" value={loan.product} />
...
export default ChangeLoanProduct;
