...
const EditSanctionDocument = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      /*
      await documentService.updateSanctionDocument(id, payload);
      */
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-semibold text-gray-900">
            Edit Sanction Document
          </h1>
          <p className="text-sm text-gray-500">
            Update document configuration for sanction stage
          </p>
        </div>
      </div>
...
export default EditSanctionDocument;
