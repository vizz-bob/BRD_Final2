...
export default function ViewJointApplicant() {
  const navigate = useNavigate();

  const data = {
    "Joint Applicant Type": "Co-Borrower",
  ...
  return (
    <MainLayout>
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold">View Joint Applicant</h1>
          <p className="text-gray-500 text-sm">
            Joint applicant configuration details
          </p>
        </div>
      </div>
