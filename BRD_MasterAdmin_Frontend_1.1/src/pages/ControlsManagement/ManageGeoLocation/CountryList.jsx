  ...
  return (
    <MainLayout>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-xl font-semibold">Manage Countries</h1>
          <p className="text-sm text-gray-500">Add, edit, or delete countries</p>
        </div>
        <button
          onClick={() => navigate("/controls/geo/country/add")}
        ...
        {filtered.map((c) => (
          ...
          >
            ...
            <div className="flex justify-end gap-2 col-span-2 md:col-span-1">
              <IconButton color="blue" onClick={() => navigate(`/controls/geo/country/edit/${c.id}`)}>
                <FiEdit3 />
              </IconButton>
