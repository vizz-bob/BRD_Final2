...
from .models import User, LoginActivity, AuditLog
from .serializers import UserSerializer, UserSignupSerializer, LoginActivitySerializer, ChangePasswordSerializer, MasterAdminTokenSerializer, TenantTokenSerializer, AuditLogSerializer
import pyotp
import qrcode
...
class AuditLogViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        try:
            return AuditLog.objects.select_related('user').all().order_by('-timestamp')
